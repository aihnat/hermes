...
public class FilteredMessageHandler {
    ...
    public void handle(FilterResult result, Message message, Subscription subscription, Consumer<OffsetsToCommit> committer) {
        if (result.isFiltered()) {
            ...
            committer.accept(new OffsetsToCommit().add(SubscriptionPartitionOffset.subscriptionPartitionOffset(message, subscription)));
